...
/* ものさがし の語（spec §15）。2歳が知っている身近な物で、兄が読みやすい2〜3字の語だけ。絵は ICONS と同じ */
KIDS.SAGASU = [
  ['いぬ','inu'],['ねこ','neko'],['くま','kuma'],['うさぎ','usagi'],['さかな','sakana'],['とり','tori'],['かめ','kame'],
  ['きりん','kirin'],['うし','ushi'],['へび','hebi'],['わに','wani'],['りす','risu'],['りんご','ringo'],['いちご','ichigo'],
  ['みかん','mikan'],['すいか','suika'],['もも','momo'],['ぱん','pan'],['たまご','tamago'],['かさ','kasa'],['くつ','kutsu'],
